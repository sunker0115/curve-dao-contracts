...
def test_apply_new_parameters_asymmetry_works(accounts, pool_proxy, susd_pool):
    ...
    pool_proxy.commit_new_parameters(susd_pool, 1000, 4000000, 0, int(asym * 0.99), {'from': accounts[1]})
...
def test_apply_new_parameters_asymmetry_fails(accounts, pool_proxy, susd_pool):
    ...
    # min is 0.36 * 1e18
    asym = 2 * (3 * 10) / (3 + 10) ** 2 * 1e18
    pool_proxy.commit_new_parameters(susd_pool, 1000, 4000000, 0, int(asym * 1.01), {'from': accounts[1]})
